...
### 🚀 Hackathon Portfolio (No Code, Just Rapid Execution)
...
**Focus:** AI Safety, Data Sovereignty, GDPR/EU AI Act Compliance

**Description:**
A bi-directional privacy firewall designed to solve the **"Enterprise AI Dilemma"** (using Cloud AI vs. keeping data safe).
